...
export const experiences = [
  ...
  },
  {
    ...
    desc: "Developed and scaled microservices using Java and Spring Boot for high performance backend systems. Conducted code reviews, mentored junior developers, and enforced clean code and SOLID principles across services.",
    skills: ["Java", "SpringBoot", "Apache Kafka", "MongoDB", "MySQL"],
  },
  {
    id: 1,
    img: nagarroLogo,
